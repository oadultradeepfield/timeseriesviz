...
As of December 2024, I’ve decided to revamp the deployment process by containerizing the app with Docker and deploying it serverlessly on Google Cloud Run. The live version is now being mapped [here](https://tsviz-k6hhpljmkq-as.a.run.app/).
